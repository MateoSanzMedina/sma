...
const navItems = [
  ...
  { label: "Proyectos", href: "/proyectos", icon: "folder_open" },
  { label: "Análisis IA", href: "/analisis", icon: "analytics" },
  { label: "CRM", href: "/crm", icon: "group" },
  { label: "Documentos", href: "/documentos", icon: "edit_document" },
  { label: "AI Tools", href: "/ai-tools", icon: "robot_2" },
  { label: "Integraciones", href: "/integraciones", icon: "extension" },
];
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col gap-1.5 mt-4 px-3 flex-1 overflow-y-auto">
        {navItems.map((item) => {
