...
def main():
    ...
    print(f"\n--- TEÓRICO SI USAMOS TOP 1 DIRECTAMENTE (MODO LOCAL SIN FILTRO GEMINI) ---")
    ...
    print(f"\n--- MÁXIMO TEÓRICO ACCESIBLE EN EL TOP 12 ---")
    ...
    print(f"\nTop 10 ítems más caros huérfanos en el MODO LOCAL (Top 1):")
