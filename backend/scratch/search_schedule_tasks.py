...
def main():
    ...
    # Search for keywords
    keywords = ["porteria", "base", "transporte", "pavimento", "cerramiento", "telecom", "totem", "excavac", "localiz"]
    print("--- BUSCANDO TAREAS EN EL CRONOGRAMA POR PALABRAS CLAVE ELÉCTRICAS/OBRA CIVIL ---")
    for kw in keywords:
